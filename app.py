...
def main() -> None:
    ...
    from bot.handlers.forward_publisher import (
        ...
        encam_agendar_menu, encam_agendar_exec, CB_AGENDAR_MENU, CB_AGENDAR_EXEC,
        encam_agendar_este_menu, encam_agendar_este_exec, CB_AGENDAR_ESTE_MENU, CB_AGENDAR_ESTE_EXEC
    )
    ...
    app.add_handler(CallbackQueryHandler(encam_agendar_menu, pattern=f"^{CB_AGENDAR_MENU}$"))
    app.add_handler(CallbackQueryHandler(encam_agendar_exec, pattern=f"^{CB_AGENDAR_EXEC}:"))
    app.add_handler(CallbackQueryHandler(encam_agendar_este_menu, pattern=f"^{CB_AGENDAR_ESTE_MENU}$"))
    app.add_handler(CallbackQueryHandler(encam_agendar_este_exec, pattern=f"^{CB_AGENDAR_ESTE_EXEC}:"))
