...
from bot.utils.constants import (
    CB_PUBLICAR_MANUAL, CB_PUBLICAR_LINK, CB_CANCELAR_MENU, CB_MONITOR_MENU, CB_GERENCIAR_CANAIS, CB_GERENCIAR_WHATS
)
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("📢 Gerenciar Canais Telegram", callback_data=CB_GERENCIAR_CANAIS)],
